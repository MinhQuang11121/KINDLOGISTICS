...
# ==========================================
# 1. CẤU HÌNH (Ông kiểm tra lại đường dẫn này)
# ==========================================
...
# ==========================================
# 2. KIẾN TRÚC STGCN (Full Code - Không thiếu một dòng)
# ==========================================
...
print("⏳ 3/4 Đang chuẩn hóa ma trận kề (Pha này nặng, đang xử lý nhanh)...")
# Cách tính Laplacian nhanh hơn, không dùng np.diag
adj_id = adj_raw + np.eye(NUM_NODES)
d_inv_sqrt = np.power(np.sum(adj_id, axis=1), -0.5)
d_inv_sqrt[np.isinf(d_inv_sqrt)] = 0.
# Đây là mẹo tính chuẩn hóa ma trận mà không làm treo máy:
...
print("🚀 BẮT ĐẦU PHÓNG! RTX A4000 ĐANG LÀM VIỆC...")
train_losses = []
...
plt.savefig(r'D:\CDIOFN\training_loss.png')
print(f"✅ Xong! Đã lưu model và đồ thị tại D:\\CDIOFN")